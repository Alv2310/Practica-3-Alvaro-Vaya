...
def visualize_paths_from_pddl(task_plan, path_to_map):
    position = (3, 35) # change this to the starting position for your PDDL problem
...
task_plan = generate_task_list('../res/planRobot.txt') # Must be a path to a text file
visualize_paths_from_pddl(task_plan, '../res/test_2.png') # path_to_map_file should be a path to an image